...
from NAT.cuda.natten import NeighborhoodAttention
...
class ConvTokenizer(BaseModule):
    def __init__(self, in_chans=3, embed_dim=96, norm_layer=None):
        ...
        self.proj = Sequential(
            Conv2d(in_chans, embed_dim // 2, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1)),
            Conv2d(embed_dim // 2, embed_dim, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1)),
        )
...
class ConvDownsampler(BaseModule):
    def __init__(self, dim, norm_layer=nn.LayerNorm):
        super().__init__()
        self.reduction = Conv2d(dim, 2 * dim, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
