...
from mmcv.cnn.bricks import Dropout, Linear

try:
    from torch.utils.cpp_extension import load
    nattenav_cuda = load(
        'nattenav_cuda', ['NAT/cuda/nattenav_cuda.cpp', 'NAT/cuda/nattenav_cuda_kernel.cu'], verbose=False)
    nattenqkrpb_cuda = load(
        'nattenqkrpb_cuda', ['NAT/cuda/nattenqkrpb_cuda.cpp', 'NAT/cuda/nattenqkrpb_cuda_kernel.cu'], verbose=False)
except:
    try:
