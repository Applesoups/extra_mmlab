...
from FAN.convnext_utils import _create_hybrid_backbone
from FAN.swin_utils import _create_fan_swin_transformer

class MlpOri(BaseModule):
...
class PositionalEncodingFourier(BaseModule):
    ...
    def __init__(self, hidden_dim=32, dim=768, temperature=10000):
        super().__init__()
        self.token_projection = Conv2d(hidden_dim * 2, dim, kernel_size=1)
...
class SqueezeExcite(BaseModule):
    def __init__(self, in_chs, se_ratio=0.25, reduced_base_chs=None,
        ...
        self.conv_reduce = Conv2d(in_chs, reduced_chs, 1, bias=True)
...
class TokenMixing(BaseModule):
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., 
        ...
        cha_sr = 1
        self.q = Linear(dim, dim // cha_sr, bias=qkv_bias)
        self.kv = Linear(dim, dim * 2 // cha_sr, bias=qkv_bias)
...
class HybridEmbed(BaseModule):
    ...
    def __init__(self, backbone, img_size=224, patch_size=2, feature_size=None, in_chans=3, embed_dim=384):
        ...
        self.proj = Conv2d(feature_dim, embed_dim, kernel_size=patch_size, stride=patch_size)
...
class ChannelProcessing(BaseModule):
...
class FAN(BaseModule):
    ...
    def __init__(self, 
        ...
        self.cls_attn_blocks = ModuleList([
            ClassAttentionBlock(
