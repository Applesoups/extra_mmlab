...
class Class_Attention(BaseModule):
...
class LayerScale_Block_CA(BaseModule):
    # taken from https://github.com/rwightman/pytorch-image-models/blob/master/timm/models/vision_transformer.py
...
class cait(BaseModule):
    ...
    def __init__(self, img_size=224,  in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.patch_embed = Patch_layer(
                img_size=img_size,  in_channels=in_chans, embed_dims=embed_dim)
        ...
        self.blocks_token_only = ModuleList([
            block_layers_token(
